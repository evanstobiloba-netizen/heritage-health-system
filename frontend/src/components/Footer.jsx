  ...
  return (
    <footer className="bg-dark px-6 md:px-12 pt-14 pb-8">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-10 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-400 leading-relaxed max-w-sm">
            Comprehensive mental health care including evaluations, counseling, and medication management. Personalized treatment plans for lasting emotional well-being.
          </p>
          <div className="flex gap-3 mt-5">
            <a href="https://www.facebook.com/heritagehealthsystem" target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-gray-400 hover:text-teal hover:border-teal transition">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://instagram.com/heritagehealthsystem1" target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-gray-400 hover:text-teal hover:border-teal transition">
            ...
            <a href="https://www.linkedin.com/company/heritagehealthsystem" target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-gray-400 hover:text-teal hover:border-teal transition">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            {[
              ...
              { label: 'Services', path: '/services/comprehensive-psychiatric-evaluation' },
      ...
      <div className="max-w-6xl mx-auto border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="text-sm text-gray-500">&copy; {new Date().getFullYear()} Heritage Healthcare System LLC. All rights reserved.</div>
      </div>
    </footer>
  )
}
